    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=128, region='MX')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('period_type', models.CharField(choices=[('semester', 'Semester'), ('summer', 'Summer'), ('quarter', 'Quarter'), ('intensive', 'Intensive'), ('trimester', 'Trimester'), ('winter', 'Winter'), ('online', 'Online'), ('continuous', 'Continuous Enrollment')], max_length=20)),
                ('is_regular_period', models.BooleanField(default=True)),
                ('next_period', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='previous_period', to='uvaq.academicperiod')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('secondary_phone', phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=128, region='MX')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('phone', phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=128, region='MX')),
                ('cell_phone', phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=128, region='MX')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hire_date', models.DateField()),
                ('staff_type', models.CharField(choices=[('academic', 'Academic'), ('administrative', 'Administrative'), ('support', 'Support'), ('technical', 'Technical'), ('services', 'Services'), ('research', 'Research'), ('maintenance', 'Maintenance'), ('other', 'Other')], max_length=20)),
                ('is_active', models.BooleanField(default=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True)),
                ('admission_period_term_code', models.CharField(blank=True, max_length=20)),
                ...
                ('generation_year', models.PositiveSmallIntegerField(blank=True, null=True)),
                ('cohort_identifier', models.CharField(blank=True, max_length=50)),
                ('status_change_date', models.DateField(blank=True, null=True)),
                ('withdrawal_date', models.DateField(blank=True, null=True)),
                ('withdrawal_reason', models.CharField(blank=True, max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('completed', 'Completed'), ('partial', 'Partial Payment'), ('cancelled', 'Cancelled'), ('waived', 'Waived'), ('refunded', 'Refunded')], default='pending', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('core', 'Core'), ('elective', 'Elective'), ('optional', 'Optional'), ('lab', 'Laboratory'), ('seminar', 'Seminar'), ('thesis', 'Thesis')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(blank=True, choices=[('secondary', 'Secondary'), ('high_school', 'High School'), ('degree', 'Degree'), ('engineer', 'Engineer'), ('specialty', 'Specialty'), ('master', 'Master'), ('doctorate', 'Doctorate'), ('other', 'Other')], max_length=20)),
                ('is_active', models.BooleanField(default=True)),
